...
Вся работа выполнялась по заданию лабораторной работы. Поведение игры должно соответствует алгоритму указанному в задании работы.

<img src="/Картинки/Демонстрация.jpg"><br>
...
## Вывод
Вся предлагаемая работа была сделана,используя графическую библиотеку TKinter. Получил представление о разработке простых игровых приложений.
